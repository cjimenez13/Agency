...
public class ClientView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_returnBackConsult.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        btn_sendEmail.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        btn_sendEmail.setText("Enviar correo");
    ...
    private void btn_sendEmailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_sendEmailActionPerformed
        ...
        if(cbox_TypeConsult.getSelectedItem().toString().equals("Identificación del cliente")){
            if(txt_IDConsult.getText().equals("")){
                JOptionPane.showMessageDialog(null,"No ha ingresado el dato para identificar al cliente");
            }else{
                int ID= Integer.valueOf(txt_IDConsult.getText());
                if (Counter.getInstance().getClient(ID).get_locker().get_cantdeliveries()==0){
                    JOptionPane.showMessageDialog(null,"No posee artículos pendientes por tanto no sera notificado");
                }else{
                    Client client= Counter.getInstance().getClient(ID);
                    String emailResult=Counter.getInstance().SendEmailNotify(client);
                    JOptionPane.showMessageDialog(null,emailResult);
            ...
            if(txt_IDConsult.getText().equals("")){
                ...
                int numLocker= Integer.valueOf(txt_IDConsult.getText());
                Client client= Counter.getInstance().getClientByLocker(numLocker);
                if (client.get_locker().get_cantdeliveries()==0){
                    JOptionPane.showMessageDialog(null,"No posee artículos pendientes por tanto no sera notificado");
                }else{
                    String emailResult=Counter.getInstance().SendEmailNotify(client);
                    JOptionPane.showMessageDialog(null,emailResult);
