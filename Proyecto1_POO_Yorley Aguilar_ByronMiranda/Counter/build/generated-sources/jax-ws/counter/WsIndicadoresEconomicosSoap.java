...
public interface WsIndicadoresEconomicosSoap {
     ...
     * @param tcFechaFinal
     * @return
     *     returns counter.ObtenerIndicadoresEconomicosResponse.ObtenerIndicadoresEconomicosResult
     */
    ...
    @RequestWrapper(localName = "ObtenerIndicadoresEconomicos", targetNamespace = "http://ws.sdde.bccr.fi.cr", className = "counter.ObtenerIndicadoresEconomicos")
    @ResponseWrapper(localName = "ObtenerIndicadoresEconomicosResponse", targetNamespace = "http://ws.sdde.bccr.fi.cr", className = "counter.ObtenerIndicadoresEconomicosResponse")
    public counter.ObtenerIndicadoresEconomicosResponse.ObtenerIndicadoresEconomicosResult obtenerIndicadoresEconomicos(
    ...
    @RequestWrapper(localName = "ObtenerIndicadoresEconomicosXML", targetNamespace = "http://ws.sdde.bccr.fi.cr", className = "counter.ObtenerIndicadoresEconomicosXML")
    @ResponseWrapper(localName = "ObtenerIndicadoresEconomicosXMLResponse", targetNamespace = "http://ws.sdde.bccr.fi.cr", className = "counter.ObtenerIndicadoresEconomicosXMLResponse")
